...
>
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{asset('/assets-dashboard/vendor/js/helpers.js')}}/assets/img/favicon/favicon.ico" />
    ...
    <!-- Vendors CSS -->
    <link rel="stylesheet" href="{{asset('/assets-dashboard/assets/vendor/js/helpers.js')}}/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css" />

    <link rel="stylesheet" href="{{asset('/assets-dashboard/assets/vendor/js/helpers.js')}}/assets/vendor/libs/apex-charts/apex-charts.css" />
  ...
  <body>
    ...
    <script src="{{asset('/assets-dashboard/assets/vendor/js/menu.js')}}../assets/"></script>
    <!-- endbuild -->
