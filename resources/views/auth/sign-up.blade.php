            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label" for="basic-default-phone">Nomor KTP</label>
                            <input type="text" id="basic-default-phone" class="form-control phone-mask"
                                placeholder="658 799 8941" />
                        </div>
                        <div class="col-md-6">
                            <label for="html5-text-input" class="form-label">Tempat Lahir</label>
                            <input class="form-control" type="text" value="Jakarta" id="html5-text-input" />
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="basic-default-fullname" placeholder="jhondae" />
                        </div>
                        <div class="col-md-6">
